...
function JPA_Nav() {
  ...
  const navItems = [
    { name: 'Dashboard', path: '/jpadmin-dash' },
    { name: 'Jobs', path: '/jpadmin-jobs' },
    { name: 'Managers', path: '/jpadmin-managers' },
    { name: 'Reports', path: '/jpadmin-reports' }
  ];
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          >
            <Link to="/jpadmin-dash" className="flex items-center">
              <img 
                src="/Logo.png" 
                alt="UniMate Logo" 
            ...
            >
              <div className="dropdown dropdown-end">
                ...
                <ul tabIndex={0} className="mt-3 p-2 shadow menu menu-compact dropdown-content bg-white rounded-box w-52 border border-gray-200">
                  <li>
                    <Link to="/jpadmin-profile" className="flex items-center gap-2">
