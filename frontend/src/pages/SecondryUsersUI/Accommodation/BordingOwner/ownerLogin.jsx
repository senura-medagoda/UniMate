...
const OwnerLogin = () => {
  ...
  const { loginOwner, owner } = useOwnerAuth();
  const { error: toastError } = useToast();

  // Redirect if already logged in
  useEffect(() => {
    if (owner) {
      console.log('Owner already logged in, redirecting to dashboard');
  ...
  const handleSubmit = async (e) => {
    ...
    console.log('OwnerLogin: Form submitted with email:', email);
    console.log('OwnerLogin: Form submitted with password length:', password.length);
      ...
      <div className="max-w-md w-full">
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-gray-200/50 p-8">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Boarding Owner Login</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link to="/owner/forgot-password" className="text-sm text-orange-600 hover:text-orange-700 font-medium transition-colors">
                Forgot password?
              </Link>
            </div>
            ...
            >
              {loading ? (
                ...
                <>
                  <span>Sign In to Boarding Owner</span>
          ...
          <div className="text-center mt-8">
            <p className="text-gray-600">
              ...
              <Link to="/owner/signup" className="text-orange-600 hover:text-orange-700 font-semibold underline transition-colors">
