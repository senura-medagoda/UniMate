         ...
         <div className='text-center mb-20 relative'>
           <div className='relative z-20 py-8'>
             <div className='mb-8'>
               ...
               <div className='text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-black text-transparent bg-gradient-to-r from-orange-600 via-amber-600 to-yellow-600 bg-clip-text tracking-tight leading-none mt-2'>
                 COLLECTION
               </div>
             </div>
...
export default M_LatestCollection