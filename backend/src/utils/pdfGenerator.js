// import puppeteer from 'puppeteer'; // Removed to prevent Vercel crash on startup
...
const generatePDFWithPuppeteer = async (reportData, reportType, period) => {
    let browser;
    try {
        console.log('Dynamically importing puppeteer...');
        // Dynamic import to avoid Vercel crash
